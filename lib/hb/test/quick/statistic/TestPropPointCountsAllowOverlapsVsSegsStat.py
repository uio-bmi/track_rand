import unittest
from quick.statistic.PropPointCountsAllowOverlapsVsSegsStat import PropPointCountsAllowOverlapsVsSegsStat
...
class TestPropPointCountsAllowOverlapsVsSegsStatUnsplittable(StatUnitTest):
    CLASS_TO_CREATE = PropPointCountsAllowOverlapsVsSegsStat
