...
class TestTrackFormat(unittest.TestCase):
    ...
    #    for formatName, dense, valued, interval in (('Points', False, None, False),\
    #                                                ('Segments', False, None, True),\
    #                                                ('Partition', True, None, True)):
    #        for strand in (False, True, None):
    #            tfReq = TrackFormatReq(name=formatName, strand=strand)
    #            self._assertFormatsReqs(tfReq, dense, valued, interval, strand)
    ...
    def testMaxCommonCoreFormat(self):
        req = TrackFormatReq.maxCommonCoreFormat( TrackFormatReq(name='segments'),
                                                  TrackFormatReq(name='points'))
        self.assertEquals(None, req)

        req = TrackFormatReq.maxCommonCoreFormat( TrackFormatReq(name='valued segments'),
                                                  TrackFormatReq(name='linked segments'))
        self.assertEquals('Segments', req.getFormatName())

        req = TrackFormatReq.maxCommonCoreFormat( TrackFormatReq(name='linked valued points'),
                                                  TrackFormatReq(name='valued points'))
        self.assertEquals('Valued points', req.getFormatName())

        req = TrackFormatReq.maxCommonCoreFormat( TrackFormatReq(name='linked step function'),
                                                  TrackFormatReq(name='step function'))
        self.assertEquals('Step function', req.getFormatName())
