...
from quick.util.TrackReportCommon import getGSuiteOverviewHtmlCore
...
class GsuiteOverviewTool(GeneralGuiTool, UserBinMixin):
    ...
    def getOptionsBoxGSuite(): # Alternatively: getOptionsBox1()
        ...
        '''
        return GeneralGuiTool.getHistorySelectionElement('gsuite', 'tabular', 'txt')
# 
#     @staticmethod
...
#         return ''
    ...
    def execute(choices, galaxyFn=None, username=''):
        ...
        coreHtml = HtmlCore()
        coreHtml.begin()
        coreHtml.append(str(getGSuiteOverviewHtmlCore(gSuiteOverview.getGSuiteOverviewData(analysisBins=analysisBins))))
        coreHtml.end()
        print coreHtml
