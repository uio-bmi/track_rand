...
class NormalizeTracksInGSuiteTool(GeneralGuiTool):
    
    NORM_STRAT_TC = 'Total count'
    NORM_STRAT_UQ = 'Upper Quartile'
    NORM_STRAT_MED = 'Median'
    NORM_STRAT_DESEQ = 'DESeq'
    NORM_STRAT_TMM = 'Trimmed Mean of M-values'
    NORM_STRAT_Q = 'Quantile'
    NORM_STRAT_RPKM = 'Reads Per Kilobase per Million'
    ...
    def getInputBoxNames():
        ...
        return [('Select a GSuite','gSuite'),
                ('Select reference track from history', 'refTrack'),
                ('Select normalization strategy', 'normStrat')]
    ...
    @classmethod
    def getOptionsBoxNormStrat(cls, prevChoices):
        return [
                cls.NORM_STRAT_RPKM,
                cls.NORM_STRAT_DESEQ,
                cls.NORM_STRAT_MED,
                cls.NORM_STRAT_Q,
                cls.NORM_STRAT_TC,
                cls.NORM_STRAT_TMM,
