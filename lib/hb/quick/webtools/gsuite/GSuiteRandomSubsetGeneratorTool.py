...
class GSuiteRandomSubsetGeneratorTool(GeneralGuiTool):
    @staticmethod
    def getToolName():
        '''
    ...
    def getInputBoxNames():
        ...
        '''
        return [('Select a GSuite file from history', 'gsuite'),
                ('Select subset method', 'subsetMethod'),
                ('Random subset size', 'subsetSize'),
                ('Number of subsets in partition', 'nrPartitions'),
                ('Randomize partition', 'randPartition')]
    ...
    @staticmethod
    def getOptionsBoxSubsetMethod(prevChoices): # Alternatively: getOptionsBox2()
        '''
        ...
        '''
        return ['Generate a random GSuite subset of determined size',
                'Generate a GSuite partition']

    @staticmethod
    def getOptionsSubsetSize(prevChoices):
        if prevChoices.subsetMethod == 'Generate a random GSuite subset of determined size':
            return ''

    @staticmethod
    def getOptionsNrPartitions(prevChoices):
        if prevChoices.subsetMethod == 'Generate a GSuite partition':
            return ''

    @staticmethod
    def getOptionsRandPartition(prevChoices):
        if prevChoices.subsetMethod == 'Generate a GSuite partition':
            return False
