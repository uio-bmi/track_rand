...
class RandomizeGsuiteTool(GeneralGuiTool):
    ...
    def getToolName(cls):
        ...
        """
        return "Creates a gsuite with randomized versions of input tracks"
    ...
    def execute(cls, choices, galaxyFn=None, username=''):
        ...
        ts = factory.getFlatTracksTS(genome, choices_gsuite)
        randTvProvider = cls.createTrackViewProvider(choices, ts, analysisBins, choices.genome)
