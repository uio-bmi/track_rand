...
class ValidateHistoryItems(GeneralGuiTool):
    @staticmethod
    def getToolName():
        '''
    ...
    def getInputBoxNames():
        ...
        '''
        return ['genome','Select datatypes of interest', 'Select history items'] #Alternatively: [ ('box1','key1'), ('box2','key2') ]
    ...
    def getOptionsBox2(prevChoices): # Alternatively: getOptionsBoxKey2()
        ...
        return OrderedDict([('bed', False), ('bedgraph', False), ('gtrack', False), ('html', False), ('fasta', False), ('category.bed', False)])
        
    @staticmethod    
    def getOptionsBox3(prevChoices):
        returnStmnt = "'__multihistory__',"
        if prevChoices[-2]:
