...
class ExamTaskScatterPlotTool(GeneralGuiTool):
    @staticmethod
    def getToolName():
        '''
        ...
        page.
        '''
        return "Tasks scatter plots generator tool"
    ...
    def getOptionsBoxTasks(prevChoices):
        if prevChoices.resultsFile:
            taskNames = ExamResultsReader.readTaskNames(
                                                        ...
                                                        TaskScatterPlotAnalysis.REQUIRED_COLUMNS, 
                                                        TaskScatterPlotAnalysis.OPTIONAL_COLUMNS)
