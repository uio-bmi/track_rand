...
class StefaniasTool(MultiGeneralGuiTool):
    @staticmethod
    def getToolName():
        '''
    ...
    def getSubToolClasses():
        return [ClustAnalysis]



class ClustAnalysis(GeneralGuiTool):

    @staticmethod
    def getToolName():
        return "Clustering tool"

    @staticmethod
    def getInputBoxNames():
        return [('Select file', 'file'),
                ("Number of randomly selected mothers", "mothers")]
    ...
    @staticmethod
    def getOptionsBoxMothers(prevChoices):
        return ""
