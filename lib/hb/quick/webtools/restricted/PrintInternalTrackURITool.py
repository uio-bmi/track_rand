...
class PrintInternalTrackURITool(GeneralGuiTool):
    @staticmethod
    def getToolName():
        '''
    ...
    def getInputBoxNames():
        ...
        '''
        return [('Select genome','genome'),('Select track', 'track')]
    ...
    def validateAndReturnErrors(choices):
        ...
        return '###genome=' + choices.genome + linesep +'hb:/' + choices.track.replace(':','/')
