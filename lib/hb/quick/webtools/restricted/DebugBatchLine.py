...
class DebugBatchLine(GeneralGuiTool):
    @staticmethod
    def getToolName():
        '''
    ...
    def getInputBoxNames():
        ...
        '''
        return ['Batch line', 'Extra verbose'] #Alternatively: [ ('box1','1'), ('box2','2') ]
    ...
    def validateAndReturnErrors(choices):
        ...
        '''
        if not choices[0]:
            return 'Please enter a batch command line'
