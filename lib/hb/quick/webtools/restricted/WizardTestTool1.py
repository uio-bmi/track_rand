...
class WizardTestTool1(GeneralGuiTool):
    NEXT_TOOL_TITLE = 'Next (click eye) ->'
    ...
    @staticmethod
    def getOptionsBoxState(): # Alternatively: getOptionsBox1()
        '''
    ...
    def execute(cls, choices, galaxyFn=None, username=''):
        ...
        '''
        print 'Tool ID: ', cls.toolId
        cls._createNextHistoryElement('hb_wizard_test_tool2', state=choices.state)

        print 'Output from tool'
