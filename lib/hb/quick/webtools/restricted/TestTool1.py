...
class TestTool1(GeneralGuiTool):
    #MAX_INPUT_BOXES = 10
    ...
    def execute(choices, galaxyFn=None, username=''):
        ...
        '''
        sum = int(choices.firstNumber) + int(choices.secondNumber)
        print sum
        #outFile = open(galaxyFn, 'w')
        #outFile.write(str(sum))
        #outFile.close()
        
        #selected = [x for x,add in choices.firstNumber.iteritems() if add]
        #print selected
    ...
    #    '''
    #    return 'html'
#TestTool1.setupVariableBoxFunctions()
