...
class HalfdansTool(GeneralGuiTool):
    @staticmethod
    def getToolName():
        return "Halfdans tool"
    ...
    def execute(cls, choices, galaxyFn=None, username=''):
        ...
        r.bitmap(bmpFn, height=height, width=width, units='px', type='png256', pointsize=12)

        return '<img src="http://www.netfonds.no/static/front-woman.png?tz=45"></img>'
        #print 'Executing...'
