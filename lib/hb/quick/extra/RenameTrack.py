#!/usr/bin/env python
from config.Config import ORIG_DATA_PATH, NONSTANDARD_DATA_PATH, PROCESSED_DATA_PATH
from gold.util.CommonFunctions import createOrigPath, createDirPath, createCollectedPath
