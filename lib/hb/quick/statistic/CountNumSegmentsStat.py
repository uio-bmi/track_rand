...
class CountNumSegmentsStat(MagicStatFactory):
    pass

class CountNumSegmentsStatSplittable(StatisticSumResSplittable):
    pass
            
class CountNumSegmentsStatUnsplittable(Statistic):
    def _compute(self):
