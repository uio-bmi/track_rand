...
from gold.track.CommonMemmapFunctions import createMemmapFileFn, findEmptyVal, calcShapeFromMemmapFileFn
...
class OutputFile(object):
    ...
    def sort(self, sortOrder=None):
        if sortOrder is None:
            # Mergesort chosen in order to be consistent with lexsort in OutputDirectory
            sortOrder = self._contents.argsort(kind='merge')
