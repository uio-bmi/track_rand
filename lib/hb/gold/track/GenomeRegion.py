...
class GenomeRegion(object):
    ...
    def __copy__(self):
        raise NotSupportedError('Shallow copy.copy() of GenomeRegion objects is not supported '
    ...
    def getCopy(self):
        return GenomeRegion(self.genome, self.chr, self.start, self.end, self.strand)
    ...
    def __len__(self):
        ''
        assert self.validAsRegion(), 'Genome element "%s" is not valid as a region ' % str(self)
    ...
    def contains(self, region):
        ...
        assert self.validAsRegion(), 'Genome element "%s" is not valid as a region ' % str(self)
        assert region.validAsRegion(), 'Genome element "%s" is not valid as a region ' % str(region)
    ...
    def exclude(self, other):
        ...
        """
        assert self.validAsRegion(), 'Genome element "%s" is not valid as a region ' % str(self)
        assert other.validAsRegion(), 'Genome element "%s" is not valid as a region ' % str(other)
